<%-- 
    Document   : index
    Created on : Oct 21, 2023, 1:47:19 PM
    Author     : PCMSI
--%>
        ...
        <div class="hero_area">
            ...
            <jsp:include page="taskbar.jsp"></jsp:include>
                ...
                <section class="slider_section">
                    <div style="background-image: url('images/samsung2.jpg');
                        ...
                        <nav class="navbar navbar-expand-lg custom_nav-container ">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <c:forEach  items="${listS}" var="o">
                                    <li class="nav-item ${now == o.supid ? "active":""} ">
                                        <a class="nav-link " href="supplier?supid=${o.supid}">
                                            ${o.supname}
                                        </a>
                                    </li>
                                </c:forEach>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav  ">
                                ...
                                <c:forEach  items="${listC}" var="o">
                                    <li class="nav-item ${now == o.cateid ? "active":""} ">
                                        <a class="nav-link " href="category?cateid=${o.cateid}">
                                            ${o.catename}
                                        </a>
                                    </li>
                                </c:forEach>
                    ...
                    <c:forEach items="${listP}" var="o">
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="box">
                                <a href="">
                                    <div class="img-box">
                                        <a href="detail?pid=${o.id}"><img src="${o.img}" alt=""></a>

                                    </div>
                                    <div class="detail-box">
                                        <h6><a href="detail?pid=${o.id}">
                                                ${o.name}
                                            </a>
                                        </h6>
                                        <h6>
                                    ...
                                    <c:if test="${sessionScope.acc.rollnum==0}">
                                        <a href="editp?id=${o.id}">
                                            <div style="background-color: #f89cab"class="new">
                                                <span>
                                                    Edit
                                                </span>
                                            </div>
